...
contract MulaInvestorsVault is Ownable{
    ...
    constructor(MulaToken token) Ownable() {
        _token = token;
    }
    ...
    function depositToVault(address beneficiary, uint256 amount, uint256 dueBy,uint identifier) onlyOperator public {
